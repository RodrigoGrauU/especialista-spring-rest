...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	//para evitar lançar stack da expcetion de forma desnecessária
	@Override
	...
	protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
		...
		String detail = "O corpo da requisição está inválido. Verifque erro de sintaxe.";
	...
	public ResponseEntity<?> hanleEntidadeNaoEncontrada(EntidadeNaoEncontradaException ex, WebRequest request) {
	...
	ResponseEntity<?> handlerEntidadeEmUso(EntidadeEmUsoException ex, WebRequest request) {
	 ...
	 *	Então, especializamos o método handleTypeMismatch e verificamos se a exception
	...
	private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,
			HttpHeaders headers, HttpStatus status, WebRequest request) {
		ProblemType problemType = ProblemType.DADOS_INVALIDOS;
		String detail = "Um ou mais campos estão inválidos. Por favor, faça o preenchimento correto e tente novamente.";
	...
	/*
	 * método auxiliar para aproveitar propriedades que precisam ser concatenadas (separando por ".")
	 * 
	 * */
